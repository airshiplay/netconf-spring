...
import com.airlenet.netconf.datasource.support.http.util.IPAddress;
import com.airlenet.netconf.datasource.support.http.util.IPRange;
...
public abstract class ResourceServlet extends HttpServlet {
    ...
    public static final String SESSION_USER_KEY = "netconf-user";
